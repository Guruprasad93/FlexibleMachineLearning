...
def train(args, model):
    ...
    if args.use_lora:
        ...
        model.to(args.device)
        num_params_lora = count_parameters(model)
        logger.info("\n")
        logger.info("Total Parameter (LoRA model): \t%2.1fM" % num_params_lora)
...
def main():
    ...
    parser.add_argument('--use_lora', action='store_true',
                            help="Whether to use lora training or normal training")
